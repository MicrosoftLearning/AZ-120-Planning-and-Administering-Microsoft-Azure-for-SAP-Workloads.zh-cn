...
>**注意**：如果已实现所有 [AZ-120 实验室先决条件](https://github.com/MicrosoftLearning/AZ-120-Planning-and-Administering-Microsoft-Azure-for-SAP-Workloads/blob/master/Instructions/AZ-120_Lab00_Prerequisites.md)，则无需完成此任务。
